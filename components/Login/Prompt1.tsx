        ...
        >
            ...
            {showAnswer && (
                <View style={{ position: 'absolute', top: 30, zIndex: 100, height: 100, width: '90%', padding: 10, alignSelf: 'center', }}>
                    <Text style={{ fontFamily: 'Poppins_600SemiBold', fontSize: 16, color: 'black', textAlign: 'center', backgroundColor: '#FF6F91', borderRadius: 20, padding: 10, marginBottom: 10, elevation: 10, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.8, shadowRadius: 2 }}>{question}</Text>
                    <TextInput
                        value={answer}
