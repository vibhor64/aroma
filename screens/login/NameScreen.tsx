    ...
    return (
        ...
        <View style={{ flex: 1, backgroundColor: '#fff', }}>
            ...
            <ScrollView contentContainerStyle={{ width: '100%', alignItems: 'center', justifyContent: 'center', padding: 20, paddingTop: 60 }}>
                ...
                <TextInput
                    style={{ height: 40, borderColor: '#E23DA0', borderWidth: 1, marginHorizontal: 20, paddingHorizontal: 10, borderRadius: 10, marginTop: 5, width: '90%', backgroundColor: '#fff', fontFamily: 'Poppins_600SemiBold', color: '#000' }}
                    value={name}
                    onSubmitEditing={() => {
                        // setText(text);
                        // updateName(text)
                ...
                <TextInput
                    style={{ height: 60, borderColor: '#E23DA0', borderWidth: 1, marginHorizontal: 20, paddingHorizontal: 10, borderRadius: 10, marginTop: 5, width: '90%', backgroundColor: '#fff', fontFamily: 'Poppins_500Medium', color: '#000' }}
                    value={bio}
                    multiline={true}
                    numberOfLines={4}
