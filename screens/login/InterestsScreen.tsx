  ...
  return (
    <>
      ...
      <ScrollView style={{ flex: 1 }} showsVerticalScrollIndicator={false}>
        ...
        <View style={{ padding: 20, paddingTop: Platform.OS === 'ios' ? 50 : 30, backgroundColor: '#fff', flex: 1 }}>
          ...
          {interests.length > 0 && (
            <TouchableOpacity activeOpacity={0.4} style={{ marginTop: 10, alignSelf: 'center', width: '90%', }} onPress={() => { navigation.navigate('Prompts') }}>
