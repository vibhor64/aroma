...
const ImagesScreen = () => {
  ...
  return (
    <View style={{ flex: 1, padding: 20, paddingTop: Platform.OS == 'android' ? 30 : 60, backgroundColor: '#fff' }}>
      ...
      <Image source={require('../../assets/icons/login page/h4.jpg')} style={{width: 70, height: 70, position: 'absolute', right: 0, top: Platform.OS == 'android' ? 26 : 50, zIndex: -1}} />
